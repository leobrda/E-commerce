...
class Categoria(models.Model): # Categorias (Masculino, Feminino, Infantil, etc)
    nome = models.CharField(max_length=200, null=True, blank=True)
...
class Tipo(models.Model): # Tipos (Camisa, Camiseta, Bermuda, etc)
    nome = models.CharField(max_length=200, null=True, blank=True)
...
class Produto(models.Model):
    ...
    def __str__(self):
        return f'Nome: {self.nome}, Categoria: {self.categoria}, Tipo: {self.tipo}, Preço: R${self.preco}'
